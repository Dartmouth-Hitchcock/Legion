...
namespace Caesar.Legion.ItemContainers {
    internal class ApplicationItemContainer {
        private const string KEY_PREFIX = "ApplicationItemContainter";
        private static Dictionary<string, object> _fakeApplicationContainer = new Dictionary<string, object>();
