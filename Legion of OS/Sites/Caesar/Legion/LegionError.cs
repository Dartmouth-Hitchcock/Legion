...
namespace Caesar.Legion {
    ...
    public class LegionError {
        ...
        internal LegionError(XmlNode xError) {
            _xError = xError;
        }
        ...
        public static implicit operator string(LegionError e) {
            return e.ToString();
        }

        public static implicit operator LegionError(Error e) {
            return new LegionError(e._xError);
        }
    }
}
